        ...
        <div id="footer-content" className="">
            <footer className="mx-auto  flex flex-row p-2 text-center items-center footer bg-neutral text-neutral-content">
                ...
                <div className="max-w-md mx-auto sm:pl-12 grid-flow-col gap-4 text-center">
                    <a href="https://github.com/nurnaoe/nft-candy-machine-solana">
                    ...
                    <a href="https://twitter.com/nurtileu14">
                    ...
                    <a href="https://discord.com/channels/869321815833575434/1032053974641152100">
